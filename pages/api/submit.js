...
function formatFieldName(key) {
  const names = {
    ...
    requestedDepartment: '⭐ Желаемый отдел',
    previousRank: '📛 Предыдущая должность',
    newRank: '⭐ Новая должность',
    reason: '📝 Причина',
...
export default async function handler(req, res) {
  ...
  const embed = {
    ...
    footer: {
      text: 'Majestic FIB Boston • ' + new Date().toLocaleDateString('ru-RU'),
    },
